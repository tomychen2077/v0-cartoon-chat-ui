...
function Home() {
    _s();
    const [publicRooms, setPublicRooms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [capacityFilter, setCapacityFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('any');
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('most_active');
    const isGuestUser = !!user && (user.is_anonymous || user.app_metadata?.provider === 'anonymous');
    const [guestError, setGuestError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const supabaseDirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
    const [authNav, setAuthNav] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const goAuth = ()=>{
        if (!authNav) {
            setAuthNav(true);
            router.replace('/auth');
    ...
    const [showAccountPrompt, setShowAccountPrompt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showCleanupWarn, setShowCleanupWarn] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [cleanupRunning, setCleanupRunning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [staleCount, setStaleCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const devCheckAbortRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const cleanupAbortRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            const fetchRooms = {
                "Home.useEffect.fetchRooms": async ()=>{
                    try {
          ...
          `).eq('is_public', true).limit(50);
                        ...
                        const roomsWithMembers = (rooms || []).map({
                            "Home.useEffect.fetchRooms.roomsWithMembers": (room)=>{
                                const members = room.room_members?.slice(0, 4).map({
                                    "Home.useEffect.fetchRooms.roomsWithMembers": (rm)=>rm.profiles
                                }["Home.useEffect.fetchRooms.roomsWithMembers"]).filter(Boolean) || [];
                        ...
                        }["Home.useEffect.fetchRooms.roomsWithMembers"]);
            ...
            fetchRooms().then({
                "Home.useEffect": async ()=>{
                    try {
                        const roomIds = (publicRooms || []).map({
                            "Home.useEffect.roomIds": (r)=>r.id
                        }["Home.useEffect.roomIds"]);
                        ...
                        const channel = supabase.channel('rooms-live').on('postgres_changes', {
                            ...
                            "Home.useEffect.channel": async (payload)=>{
                                const roomId = payload.new?.room_id;
                                const userId = payload.new?.user_id;
                                if (!roomId || !userId) return;
                                setPublicRooms({
                                    "Home.useEffect.channel": (prev)=>{
                                        const idx = prev.findIndex({
                                            "Home.useEffect.channel.idx": (r)=>r.id === roomId
                                        }["Home.useEffect.channel.idx"]);
                                        if (idx === -1) return prev;
                                        const room = prev[idx];
                                        const exists = room.members?.some({
                                            "Home.useEffect.channel": (m)=>m?.id === userId || m?.user_id === userId
                                        ...
                                        if (!exists) {
                                            ...
                                            supabase.from('profiles').select('id, username, display_name, avatar_url').eq('id', userId).single().then({
                                                "Home.useEffect.channel": ({ data })=>{
                                                    if (!data) return;
                                                    setPublicRooms({
                                                        "Home.useEffect.channel": (prev2)=>{
                                                            const i2 = prev2.findIndex({
                                                                "Home.useEffect.channel.i2": (r)=>r.id === roomId
                                                            }["Home.useEffect.channel.i2"]);
                                                            if (i2 === -1) return prev2;
                                                            const r2 = prev2[i2];
                                                            const mems = r2.members ? [
                                                                ...r2.members
                                                            ] : [];
                                                            const already = mems.some({
                                                                "Home.useEffect.channel.already": (m)=>m.id === data.id
                                                            }["Home.useEffect.channel.already"]);
                        ...
                        }["Home.useEffect.channel"]).on('postgres_changes', {
                            event: 'DELETE',
                            schema: 'public',
                            table: 'room_members'
                        }, {
                            "Home.useEffect.channel": async (payload)=>{
                                ...
                                setPublicRooms({
                                    "Home.useEffect.channel": (prev)=>{
                                        ...
                                        if (idx === -1) return prev;
                                        const room = prev[idx];
                                        const mems = (room.members || []).filter({
                                            "Home.useEffect.channel.mems": (m)=>m.id !== userId && m.user_id !== userId
                                        }["Home.useEffect.channel.mems"]);
            ...
            checkUser();
            const checkCleanup = {
                "Home.useEffect.checkCleanup": async ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const t = window.setTimeout({
                "Home.useEffect.t": ()=>setShowCleanupWarn(false)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showAccountPrompt && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                role: "alert",
                "aria-live": "polite",
            ...
            showCleanupWarn && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                role: "alert",
                "aria-live": "polite",
                            ...
                            children: publicRooms.filter((room)=>{
                                ...
                                return (b.liveCount ?? 0) - (a.liveCount ?? 0);
                                    ...
                                    children: [
                                        ...
                                        room.creator && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: room.creator.avatar_url ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        ...
                                        room.members && room.members.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "flex items-center gap-2 mb-3 sm:mb-4",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex -space-x-2 overflow-x-auto max-w-full pr-1",
                                                    children: room.members.slice(0, 8).map((member, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: member.avatar_url ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                ...
                                                (room.liveCount ?? room.member_count ?? 0) > 8 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(Home, "xqu3lob1qhP1iFhkaSvKqkFyqSk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_dda172c1._.js.map