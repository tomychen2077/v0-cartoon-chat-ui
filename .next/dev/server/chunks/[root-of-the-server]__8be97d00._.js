...
"[project]/app/api/rooms/join/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: room, error: roomErr } = await supabase.from('rooms').select('*').eq('id', room_id).single();
        if (roomErr || !room) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (room.is_private && !isOwner) {
            ...
            const { data: inviteList } = await supabase.from('room_invites').select('*').eq('token', token).eq('room_id', room_id).eq('status', 'active').limit(1);
        ...
        if (room.is_private && !isOwner && token && inviteRow) {
            await supabase.from('room_invites').update({
                ...
                status: inviteRow.max_uses && inviteRow.uses + 1 >= inviteRow.max_uses ? 'inactive' : 'active'
            }).eq('id', inviteRow.id);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8be97d00._.js.map