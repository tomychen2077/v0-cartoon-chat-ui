...
async function updateSession(request) {
    ...
    if (!user && !request.nextUrl.pathname.startsWith("/auth") && !request.nextUrl.pathname.startsWith("/guest") && request.nextUrl.pathname !== "/" && !request.nextUrl.pathname.startsWith("/room")) {
