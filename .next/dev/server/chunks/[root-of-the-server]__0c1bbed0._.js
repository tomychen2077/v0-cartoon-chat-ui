...
"[project]/app/api/friends/get/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
      ...
      `).or(`user_id.eq.${user.id},friend_id.eq.${user.id}`).eq('status', status);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c1bbed0._.js.map