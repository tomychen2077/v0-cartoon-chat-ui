...
"[project]/app/api/room-members/cleanup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        let error = null;
        const { error: err1 } = await admin.from('room_members').delete().lt('last_seen', cutoff);
        error = err1;
        if (error) {
            await admin.from('room_members').delete().lt('joined_at', cutoff);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d0461bf6._.js.map