...
"[project]/app/api/friends/decline/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: friendRequest, error: fetchError } = await supabase.from('friends').select('*').eq('id', friend_request_id).eq('status', 'pending').single();
        ...
        const { error } = await supabase.from('friends').delete().eq('id', friend_request_id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b14e7be7._.js.map