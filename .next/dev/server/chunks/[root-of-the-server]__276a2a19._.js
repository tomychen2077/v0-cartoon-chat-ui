...
"[project]/app/api/friends/accept/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { data: friendRequest, error: fetchError } = await supabase.from('friends').select('*').eq('id', friend_request_id).eq('friend_id', user.id).eq('status', 'pending').single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__276a2a19._.js.map