...
"[project]/app/api/notifications/bulk/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const list = Array.isArray(recipients) ? recipients.filter((x)=>typeof x === 'string') : [];
        const t = typeof type === 'string' ? type : '';
        if (!list.length || !t) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'recipients and type are required'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c16e1dc5._.js.map